        ...
        if request.method == "POST":
            ...
            for i in range(0, 20):
                ...
                item = {
                    ...
                    "valor_total": str(dados.get(f"valor_total_{i}")).replace(".", "").replace(",", ".").strip(),
                ...
                item_teclado = {
                    ...
                    "valor_total": str(float(str(dados.get(f"teclado_{i}")).replace(".", "").replace(",", ".").strip()) * float(str(dados.get(f"quantidade_{i}")).strip())),
                    "centro": "",
                    "deposito": "",
                    "over": "",
                    "garantia": "",
                ...
                item_mouse = {
                    ...
                    "valor_total": str(float(str(dados.get(f"mouse_{i}")).replace(".", "").replace(",", ".").strip()) * float(str(dados.get(f"quantidade_{i}")).strip())),
                    "centro": "",
                    "deposito": "",
                    "over": "",
                    "garantia": "",
