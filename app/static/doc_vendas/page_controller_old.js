    ...
    itemsControllerInit() {
        ...
        this.addItemButton.addEventListener("click", () => {
            ...
            const camposItem = [
                ...
                { label: "Valor Unitário", type: "number", name: "valor" },
                ...
                { label: "Valor Total", type: "texto", name: "garantia" },
                    ...
                    campoInput.addEventListener("change", () => {
                        ...
                        for (let opcao of opcoes) {
                            ...
                            if (opcao.value == descricaoGarantia) {
                                ...
                                // ~~ Armazena valor temporariamente para usar posteriormente.
                                this.inputGarantia = valorGarantia;
                            }
                        }
                    });
                }
                ...
                if (campo.label === "TCL/MOU") {
                    ...
                    const recalcularValor = () => {
                        ...
                        if (valor && valor != 0) {
                            ...
                            const valorGarantia = parseFloat(this.inputGarantia.value) || 0;
